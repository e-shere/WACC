...
object asm {
  ...
  case class Mov(cond: String = "")(target: AsmReg, source: AsmArg) extends AsmInstr {
    val opcode = "MOV"
    override def argsToString: String = s"$target, $source"
  }

  case class Push(cond: String = "")(arg: AsmArg) extends AsmInstr {
    val opcode = "PUSH"
    override def argsToString = s"{$arg}"
  }

  case class Pop(cond: String = "")(arg: AsmArg) extends AsmInstr {
    val opcode = "POP"
    override def argsToString = s"{$arg}"
  }

  case class Or(cond: String = "")(target: AsmReg, x: AsmReg, y: AsmArg) extends AsmInstr {
    val opcode = "ORR"
    override def argsToString: String = s"$target, $x, $y"
  }

  case class And(cond: String = "")(target: AsmReg, x: AsmReg, y: AsmArg) extends AsmInstr {
    val opcode = "AND"
    override def argsToString: String = s"$target, $x, $y"
  }

  case class Compare(cond: String = "")(x: AsmReg, y: AsmArg) extends AsmInstr {
    val opcode = "CMP"
    override def argsToString: String = s"$x, $y"
  }

  case class Adds(cond: String = "")(target: AsmReg, x: AsmReg, y: AsmArg) extends AsmInstr {
    val opcode = "ADDS"
    override def argsToString: String = s"$target, $x, $y"
  }

  case class Subs(cond: String = "")(target: AsmReg, x: AsmReg, y: AsmArg) extends AsmInstr {
    val opcode = "SUBS"
    override def argsToString: String = s"$target, $x, $y"
  }
...
//  }
  ...
  case class Not(cond: String = "")(target: AsmReg, x: AsmArg) extends AsmInstr {
    val opcode = "EOR"
    def argsToString = s"$target, $x, #1"
  }

  case class Neg(cond: String = "")(target: AsmReg, x: AsmArg)  extends AsmInstr {
    val opcode = "RSBS"
    override def argsToString = s"$target, $x, #0"
  }

  case class Ldr(cond: String = "")(target: AsmReg, source: AsmArg)(offset: AsmInt = AsmInt(0)) extends AsmInstr {
  ...
  case class Str(cond: String = "")(source: AsmReg, target: AsmArg)(offset: AsmInt = AsmInt(0)) extends AsmInstr {
  ...
  object Len {
    def apply(cond: String = "")(target: AsmReg, x: AsmArg): Step = Ldr(cond)(target, x)()
  }

  object Eq {
    def apply(cond: String = "")(target: AsmReg, x: AsmReg, y: AsmArg): Step = (
           Compare(cond)(x, y)
